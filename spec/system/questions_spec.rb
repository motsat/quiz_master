...
RSpec.describe 'Questions', type: :system do
  describe "show default quiz" do
    let!(:question) { FactoryBot.create(:question, title: "How many vowels are there in the English alphabet", right_answer: 47, display_order: 1) }
  ...
  describe "can answer" do
    context "When answer is right" do
      context "When there is a next question" do
        let!(:question_1) { FactoryBot.create(:question, title: "How many vowels are there in the English alphabet", right_answer: 47, display_order: 1) }
        let!(:question_2) { FactoryBot.create(:question, title: "1.0 + 2.1 = ?", right_answer: 3.1, display_order: 2) }
        before do 
          visit root_path
    ...
    context "When answer is wrong" do
      let!(:question) { FactoryBot.create(:question, title: "1.0 + 2.1 = ?", right_answer: 3.1) }
      before do 
        visit root_path
